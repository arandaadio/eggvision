...
app.config['MAIL_USERNAME'] = 'eggvision5@gmail.com' # Your Gmail
app.config['MAIL_PASSWORD'] = 'rtuf zikj quxh rbjx'  # The 16-char App Password
app.config['MAIL_USE_TLS'] = False
app.config['MAIL_USE_SSL'] = True
app.config['MAIL_DEFAULT_SENDER'] = ('EggVision Contact', 'eggvision5@gmail.com')
